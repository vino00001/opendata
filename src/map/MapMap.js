...
export function createMap(){
    ...
    map.on("click", e => {  //when a specific marker is pressed
        map.forEachFeatureAtPixel(e.pixel, feature => {
            document.getElementById("popup-content").innerHTML = `<p>You clicked on ${feature.values_.coordinates.latitude}, ${feature.values_.coordinates.longitude}`;  //display message
