...
export function OpendataFilter(props){
    ...
    return <div className ="Sidebar">
       <a onClick = {Check1}><input type="checkbox" id="AmerikanskBox"></input> Amerikanskt</a>
       <a onClick = {Check2}><input type="checkbox" id="KinesiskBox"></input> Kinesiskt</a>
       <a onClick = {Check3}><input type="checkbox" id="ThaiBox"></input> Thai</a>
       <a onClick = {Check4}><input type="checkbox" id="AsiatiskBox"></input> Asiatiskt</a>
       <a onClick = {Check5}><input type="checkbox" id="PizzaBox"></input> Pizza</a>
       <a onClick = {Check6}><input type="checkbox" id="VegitariskBox"></input> Vegitariskt</a>
       <a onClick = {Check7}><input type="checkbox" id="HamburgareBox"></input> Hamburgare</a>
       <a onClick = {Check8}><input type="checkbox" id="SalladBox"></input> Sallad</a>
       <a onClick = {Check9}><input type="checkbox" id="KebabBox"></input> Kebab</a>
       <a onClick = {Check10}><input type="checkbox" id="SushiBox"></input> Sushi</a>
    </div>
